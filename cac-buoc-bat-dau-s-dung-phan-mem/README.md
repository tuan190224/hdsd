...
Để bắt đầu sử dụng phần mềm, người dùng cần đăng nhập vào hệ thống phần mềm quản lý vận tải theo đường link **http://**[<mark style="color:yellow;">**tencongty**</mark>](#user-content-fn-1)[^1]**.tts-vn.com/.** Đăng nhập bằng tài khoản và mật khẩu.
