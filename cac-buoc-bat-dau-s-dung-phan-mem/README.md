...
* Bước 1: Vào mục Quản lý hệ thống <img src="../.gitbook/assets/image (4).png" alt="" data-size="line">  , chọn mục Quản lý nhóm&#x20;
* Bước 2: Chọn thêm mới để thêm mới người dùng ![](file:///tmp/lu14809ds5z3.tmp/lu14809ds601\_tmp\_ffeae6066a161502.png)
* Bước 4: Nhập các thông tin (Tên nhóm, Tên ngắn gọn và Miêu tả)
* Bước 5: Nhấn nút Lưu ![](file:///tmp/lu14809ds5z3.tmp/lu14809ds601\_tmp\_433ef73b24dce877.png) để lưu lại thông tin nhóm vừa tạo, hoặc Đóng ![](file:///tmp/lu14809ds5z3.tmp/lu14809ds601\_tmp\_ff677f43b63c6b39.png) để hủy bỏ

Người dùng có thể sửa thông tin của nhóm bằng cách nhấn vào nút ![](<../.gitbook/assets/9 (1).png>), thay đổi thông tin và ấn **Lưu.** Xóa nhóm bằng cách nhấn nút ![](<../.gitbook/assets/10 (5).png>) và ![](<../.gitbook/assets/11 (2).png>)
