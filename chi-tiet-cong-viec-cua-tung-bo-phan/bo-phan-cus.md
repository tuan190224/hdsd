...
### **Ộ PHẬN CUS** <a href="#_34g0dwd" id="_34g0dwd"></a>

### **Quản lý lô hàng đủ/ rút gọn** <a href="#_1jlao46" id="_1jlao46"></a>
...
#### **Tạo mới lô hàng** <a href="#_43ky6rz" id="_43ky6rz"></a>
...
Bước 2: Nhấn nút ![](<../.gitbook/assets/1 (6).png>) 🡪 Điền các thông tin vào bảng thêm mới. Nhập các thông tin lô hàng bằng cách nhấp chuột và chọn dữ liệu.

![](<../.gitbook/assets/2 (7).png>) ![](<../.gitbook/assets/3 (5).png>)
...
#### **Thêm mới danh sách cont** <a href="#_2iq8gzs" id="_2iq8gzs"></a>
...
* Nhập cùng lúc nhiều Cont hàng theo danh sách từ file excel sẵn có bằng cách nhấn **Thêm file excel** ![](<../.gitbook/assets/4 (1).png>)🡪 Chọn file excel sẵn có trên máy người dùng 🡪 Nhấn **Lưu** và xác nhận yêu cầu lưu.
...
* Hoặc: Nhập từng Cont hàng trực tiếp vào phần mềm: Nhấn chọn ![](<../.gitbook/assets/7 (6).png>)🡪 nhập thông tin từng cont hàng🡪 nhấn **Lưu.** Thông tin về cont hàng của lô được hiển thị trên phần mềm.
...
#### **Chuyển trạng thái lô hàng** <a href="#_xvir7l" id="_xvir7l"></a>
...
### **Danh sách lô hàng** <a href="#_3hv69ve" id="_3hv69ve"></a>
...
#### **Quản lý trạng thái cont hàng** <a href="#_1x0gk37" id="_1x0gk37"></a>

Người dùng cập nhật trạng thái cùng từng cont hàng bằng cách nhấn vào ![](<../.gitbook/assets/14 (5).png>) 🡪 Nhập thông tin về cont.
...
#### **Quản lý cảnh báo** <a href="#_4h042r0" id="_4h042r0"></a>
...
Bước 2: Nhấn ![](<../.gitbook/assets/17 (7).png>), các chi phí tạm ứng định mức của lô hàng được hiển thị. Chỉnh sửa trực tiếp vào các ô số lượng, đơn giá tạm ứng, thêm ghi chú nếu cần 🡪 Nhấn nút Lưu cuối bảng.
