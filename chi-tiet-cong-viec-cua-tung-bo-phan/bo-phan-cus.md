...
![](<../.gitbook/assets/2 (8).png>) ![](<../.gitbook/assets/3 (6).png>)
...
* Nhập cùng lúc nhiều Cont hàng theo danh sách từ file excel sẵn có bằng cách nhấn **Thêm file excel** ![](<../.gitbook/assets/4 (2).png>)🡪 Chọn file excel sẵn có trên máy người dùng 🡪 Nhấn **Lưu** và xác nhận yêu cầu lưu.
...
Bước 1: Sau khi có lô hàng tạo trên phần mềm, tại cột **Chức năng**, người dùng thêm mới danh sách cont hàng bằng cách nhấn nút ![](<../.gitbook/assets/9 (1).png>)
