...
### **Quản lý Quyết toán nội bộ (Quản lý QTNB)** <a href="#_j8sehv" id="_j8sehv"></a>
...
#### **Quản lý tạm ứng theo lô hàng** <a href="#_338fx5o" id="_338fx5o"></a>

**Tạo tạm ứng nội bộ cho nhân viên**
...
**Quản lý quyết toán tạm ứng (Quyết toán nội bộ - QTNB)**
...
Nhấn nút ![](<../.gitbook/assets/11 (5).png>) trong trường hợp người dùng muốn thay đổi lại nhóm của chi phí:
...
* _Trường hợp có Tạm ứng phát sinh, người dùng nhấn_ ![](<../.gitbook/assets/14 (3).png>) _trong bảng QTNB để cập nhật chi phí của các tạm ứng phát sinh vào chung một phiếu QTNB._

#### **Quản lý tạm ứng theo ngày** <a href="#_wnyagw" id="_wnyagw"></a>
...
#### **Quản lý linh hoạt theo lô và theo ngày** <a href="#_3gnlt4p" id="_3gnlt4p"></a>

**Quản lý tạm ứng cho Ops**
...
### **Quản lý Quyết toán Khách hàng (Quản lý QTKH)** <a href="#_1vsw3ci" id="_1vsw3ci"></a>

#### **Mở quyết toán Khách hàng** <a href="#_4fsjm0b" id="_4fsjm0b"></a>
...
#### **Cập nhật Quyết toán KH** <a href="#_2uxtw84" id="_2uxtw84"></a>
...
### **Quản lý Cược vỏ** <a href="#_1a346fx" id="_1a346fx"></a>

#### **Tạo thông tin cược vỏ** <a href="#_3u2rp3q" id="_3u2rp3q"></a>
...
#### **Cập nhật thông tin cược vỏ** <a href="#_2981zbj" id="_2981zbj"></a>
...
### **Quản lý Sửa chữa** <a href="#_odc9jc" id="_odc9jc"></a>

Quản lý sửa chữa là các khoản tạm ứng và quyết toán cho việc sửa chữa xe.

#### **Thêm mới tạm ứng sửa chữa** <a href="#_38czs75" id="_38czs75"></a>
...
#### **Quản lý chi phí và trạng thái hóa đơn sửa chữa** <a href="#_1nia2ey" id="_1nia2ey"></a>
...
* _Trong thời gian cho phép, phần mềm vẫn cho phép người dùng mở lại hóa đơn đã đóng để chỉnh sửa thông tin nếu có sai sót 🡪 Nhấn nút🡪 chuyển trạng thái sang Mở🡪 Lưu. (Phân quyền chặt chẽ cho người có quyền mở lại hóa đơn)._
...
### **Quản lý khấu hao chung** <a href="#_2mn7vak" id="_2mn7vak"></a>
...
#### **Thêm mới và quản lý chi phí** <a href="#_11si5id" id="_11si5id"></a>
...
#### **Tiện ích bổ sung** <a href="#_3ls5o66" id="_3ls5o66"></a>

**Tìm kiếm theo trạng thái**&#x20;

**In đề xuất thanh toán**
...
### **Quản lý thu chi** <a href="#_20xfydz" id="_20xfydz"></a>
...
#### **Theo dõi sổ thu chi** <a href="#_4kx3h1s" id="_4kx3h1s"></a>
...
#### **Cập nhật sổ thu chi** <a href="#_302dr9l" id="_302dr9l"></a>
...
#### **Biểu đồ thống kê thu chi** <a href="#_1f7o1he" id="_1f7o1he"></a>
