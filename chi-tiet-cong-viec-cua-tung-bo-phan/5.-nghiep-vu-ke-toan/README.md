...
![Các bước thêm mới tạm ứng nội bộ một lô hàng](<../../.gitbook/assets/2 (4).png>)
...
<figure><img src="../../.gitbook/assets/15 (7).png" alt=""><figcaption><p><em><strong>Màn hình Quản lý quỹ</strong></em></p></figcaption></figure>
...
![Màn hình thêm mới trong Quản lý tạm ứng](<../../.gitbook/assets/16 (5).png>)
...
![Màn hình thanh toán](<../../.gitbook/assets/18 (2).png>)
...
Bước 1: Tại mục Quản lý lô đủ/rút gọn, nhấn vào cột Quyết toán 🡪 Trong bảng Quyết toán, nhấn chọn ![](<../../.gitbook/assets/image (143).png>)

Nhấn nút ![](<../../.gitbook/assets/image (138).png>) khi có thêm thanh toán chi phí của lô làm quyết toán.
...
<figure><img src="../../.gitbook/assets/image (95).png" alt=""><figcaption><p><em><strong>Màn hình Quyết toán khách hàng</strong></em></p></figcaption></figure>

Bước 3: Nhấn nút 🡪 ![](<../../.gitbook/assets/image (55).png>) Phần mền hiện thị ra danh sách các khoản cần quyết toán với khách hàng
...
* Thêm mới chi phí trên QTKH: nút ![](<../../.gitbook/assets/image (76).png>)
* Cập nhật QTKH khi có phát sinh tạm ứng và QTNB: nút ![](<../../.gitbook/assets/image (87).png>)
...
<figure><img src="../../.gitbook/assets/image (98).png" alt=""><figcaption><p><em><strong>Màn hình tổng hợp Quyết toán khách hàng</strong></em></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (51).png" alt=""><figcaption><p><em><strong>Màn hình nhập thanh toán khách hàng</strong></em></p></figcaption></figure>
...
* Người dùng có thể đóng QTKH từ mục Ql lô hàng 🡪 QTKH ![](<../../.gitbook/assets/image (83).png>)
...
<figure><img src="../../.gitbook/assets/image (89).png" alt=""><figcaption><p><em><strong>Màn hình Quản lý QTKH</strong></em></p></figcaption></figure>

### **5.3 Quản lý Cược vỏ** <a href="#_1a346fx" id="_1a346fx"></a>

#### **5.3.1 Tạo thông tin cược vỏ** <a href="#_3u2rp3q" id="_3u2rp3q"></a>

Bước 1: Tại mục Quản lý lô đủ/ rút gọn 🡪 Vào tạm ứng lô hàng 🡪 nhấn nút ![](<../../.gitbook/assets/image (33).png>)
...
<figure><img src="../../.gitbook/assets/image (88).png" alt=""><figcaption><p><em><strong>Màn hình Quản lý cược vỏ</strong></em></p></figcaption></figure>
...
Bước 1: Trong mục Kế toán, chọn QL cược vỏ. Nhấn nút <img src="../../.gitbook/assets/image (93).png" alt="" data-size="line"> tại lô hàng muốn cập nhật thông.
...
<figure><img src="../../.gitbook/assets/image (60).png" alt=""><figcaption><p><em><strong>Màn hình cập nhật Quản lý cược vỏ</strong></em></p></figcaption></figure>
...
Bước 1: Tại mục Kế toán, chọn chức năng QL sửa chữa. Nhấn nút <img src="../../.gitbook/assets/image (66).png" alt="" data-size="line">  để thêm thông tin sửa chữa.

<figure><img src="../../.gitbook/assets/image (166).png" alt=""><figcaption><p><em><strong>Màn hình Quản lý sửa chữa</strong></em></p></figcaption></figure>
...
* _Trong thời gian cho phép, phần mềm vẫn cho phép người dùng mở lại hóa đơn đã đóng để chỉnh sửa thông tin nếu có sai sót 🡪 Nhấn nút_  <img src="../../.gitbook/assets/image (32).png" alt="" data-size="line">_🡪 chuyển trạng thái sang Mở🡪 Lưu. (Phân quyền chặt chẽ cho người có quyền mở lại hóa đơn)._
...
<figure><img src="../../.gitbook/assets/image (79).png" alt=""><figcaption><p><em><strong>Màn hình quản lý phí khấu hao</strong></em></p></figcaption></figure>
...
Bước 1: Tại chi phí muốn tạo đề xuất, nhấn nút <img src="../../.gitbook/assets/image (44).png" alt="" data-size="line"> trong cột chức năng.

Bước 2: Lựa chọn người thanh toán, nhấn nút ![](<../../.gitbook/assets/image (59).png>).

<figure><img src="../../.gitbook/assets/image (40).png" alt=""><figcaption><p><em><strong>Mẫu phiếu in đề xuất thanh toán phí khấu hao</strong></em></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (41).png" alt=""><figcaption><p><em><strong>Màn hình quản lý sổ thu chi</strong></em></p></figcaption></figure>
...
Bước 1: Tại bảng Quản lý thu chi, nhấn nút <img src="../../.gitbook/assets/image (74).png" alt="" data-size="line">
...
Bước 2: Nhấn nút <img src="../../.gitbook/assets/image (99).png" alt="" data-size="line"> để bỏ cảnh báo
...
<figure><img src="../../.gitbook/assets/image (175).png" alt=""><figcaption><p><em><strong>Màn hình biểu đồ thống kê thu chi</strong></em></p></figcaption></figure>
