# BỘ PHẬN QUẢN LÝ NHIÊN LIỆU

### **Quản lý nhập nhiên liệu** <a href="#_qbtyoq" id="_qbtyoq"></a>
...
* _Mục người phụ trách là vị trí Chung được nhập trong mục nhân viên trong phần nhập Thông tin chung._
* _Tỷ lệ hao hụt dùng để tính lượng hao hụt trong báo cáo tồn dầu._

### **Quản lý định mức dầu chuyến xe** <a href="#_3abhhcj" id="_3abhhcj"></a>
...
### **Quản lý cấp dầu cho xe** <a href="#_49gfa85" id="_49gfa85"></a>
...
#### **Thêm mới dầu cấp từng xe** <a href="#_2olpkfy" id="_2olpkfy"></a>
...
#### **Tải file excel dầu cấp nhiều xe** <a href="#_13qzunr" id="_13qzunr"></a>

Bước 1: Tại màn hình Ql cấp dầu cho xe, nhấn nút ![](<../.gitbook/assets/7 (7).png>)
