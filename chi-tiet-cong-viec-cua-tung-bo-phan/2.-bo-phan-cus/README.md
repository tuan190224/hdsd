...
Bước 2: Nhấn nút ![](<../../.gitbook/assets/1 (7).png>) 🡪 Điền các thông tin vào bảng thêm mới. Nhập các thông tin lô hàng bằng cách nhấp chuột và chọn dữ liệu.

![](<../../.gitbook/assets/2 (9).png>) ![](<../../.gitbook/assets/3 (7).png>)
...
![Màn hình chi tiết danh sách cont hàng](<../../.gitbook/assets/13 (2).png>)
