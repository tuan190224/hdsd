...
Bước 2: Nhấn nút ![](<../../.gitbook/assets/1 (10).png>) 🡪 Điền các thông tin vào bảng thêm mới. Nhập các thông tin lô hàng bằng cách nhấp chuột và chọn dữ liệu.
...
![Màn hình thêm mới thông tin điều xe](<../../.gitbook/assets/11 (5).png>)
...
![Màn hình chi tiết danh sách cont hàng](<../../.gitbook/assets/13 (6).png>)
...
Bước 2: Nhấn ![](<../../.gitbook/assets/17 (6).png>), các chi phí tạm ứng định mức của lô hàng được hiển thị. Chỉnh sửa trực tiếp vào các ô số lượng, đơn giá tạm ứng, thêm ghi chú nếu cần 🡪 Nhấn nút Lưu cuối bảng.

![Bảng tạm ứng lô hàng](../../.gitbook/assets/18.png)
...
![Màn hình Kế toán - Ql Quyết toán nội bộ](<../../.gitbook/assets/20 (9).png>)
