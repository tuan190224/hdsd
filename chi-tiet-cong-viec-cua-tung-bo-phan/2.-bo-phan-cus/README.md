...
![Màn hình quản lý lô hàng đủ](<../../.gitbook/assets/0 (7).png>)

Bước 1: Trong thanh menu bên trái, tại mục **Điều hành**🡪 nhấn chọn **Quản lý lô hàng đủ/ rút gọn** tùy theo mục đích quản lý

Bước 2: Nhấn nút ![](<../../.gitbook/assets/1 (9).png>) 🡪 Điền các thông tin vào bảng thêm mới. Nhập các thông tin lô hàng bằng cách nhấp chuột và chọn dữ liệu.
...
Người dùng cập nhật trạng thái cùng từng cont hàng bằng cách nhấn vào ![](../../.gitbook/assets/14.png) 🡪 Nhập thông tin về cont.
