...
Bước 1: Sau khi có lô hàng tạo trên phần mềm, tại cột **Chức năng**, người dùng thêm mới danh sách cont hàng bằng cách nhấn nút ![](<../../.gitbook/assets/9 (2).png>)
...
![Màn hình cập nhập trạng thái cont](<../../.gitbook/assets/15 (6).png>)
