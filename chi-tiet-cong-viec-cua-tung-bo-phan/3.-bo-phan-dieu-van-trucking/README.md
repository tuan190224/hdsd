...
Bước 3: Phầm mềm cũng hỗ trợ tạo điều xe từ kế hoạch vận chuyển với nút tắt ![](<../../.gitbook/assets/2 (8).png>). Điều kiện sử dụng nút tắt:
...
![Màn hình thêm mới Kế hoạch vận chuyển](<../../.gitbook/assets/3 (1).png>)
...
* Trường hợp sử dụng xe ngoài chưa khai báo trong danh sách xe. Nhấn chọn thêm xe ![](<../../.gitbook/assets/7 (9).png>) tại bảng Thêm kế hoạch điều xe. Sau đó điền thông tin xe muốn điều.
...
* _Mỗi trạng thái sẽ hiển thị màu khác nhau:_ <img src="../../.gitbook/assets/image (59).png" alt="" data-size="original"><img src="../../.gitbook/assets/image (76).png" alt="" data-size="original">![](<../../.gitbook/assets/image (100).png>)![](<../../.gitbook/assets/image (68).png>)![](<../../.gitbook/assets/image (10).png>)
...
<figure><img src="../../.gitbook/assets/image (82).png" alt=""><figcaption><p><em><strong>Màn hình điều vận vận tải biển</strong></em></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (65).png" alt=""><figcaption><p><em><strong>Màn hình thêm mới/cập nhật lại chuyến điều vận vận tải biển</strong></em></p></figcaption></figure>
...
Bước 2: Trường hợp chưa có dữ liệu hoặc cần thay đổi, người dùng có thể chỉnh sửa trực tiếp tại các ô chữ màu xanh hoặc quay lại nhập từ TTC rồi chọn ![](<../../.gitbook/assets/image (86).png>)  để cập nhật lại cước.
...
Cách 1: Làm mới chi phí một chuyến xe🡪 Nhấn nút ![](<../../.gitbook/assets/image (81).png>) để lấy lại giá trị định mức ban đầu.
...
Bước 2: Trường hợp chưa có dữ liệu hoặc cần thay đổi, người dùng có thể chỉnh sửa trực tiếp tại các ô chữ màu xanh hoặc quay lại nhập từ TTC rồi chọn ![](<../../.gitbook/assets/image (89).png>) để cập nhật lại chi phí.
...
Bước 2: Kéo đến cột chức năng cuối bảng Ql chi phí vc🡪 Nhận nút ![](<../../.gitbook/assets/image (73).png>)

Bước 3: Lựa chọn thông tin định mức muốn lưu trữ 🡪 Lưu

<figure><img src="../../.gitbook/assets/image (55).png" alt=""><figcaption><p><em><strong>Màn hình lưu ngược định mức tiền đường</strong></em></p></figcaption></figure>
...
Cách 1: Làm mới chi phí một chuyến xe🡪 Nhấn nút ![](<../../.gitbook/assets/image (5).png>) để lấy lại giá trị định mức ban đầu.
...
<figure><img src="../../.gitbook/assets/image (3).png" alt=""><figcaption><p><em><strong>Màn hình nhập thông báo</strong></em></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (70).png" alt=""><figcaption><p><em><strong>Màn hình báo cáo hoạt động theo xe</strong></em></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (87).png" alt=""><figcaption><p><em><strong>Màn hình báo cáo hoạt động khách hàng</strong></em></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (113).png" alt=""><figcaption><p><em><strong>Màn hình Báo cáo tải trọng an toàn đầu kéo</strong></em></p></figcaption></figure>
...
Bước 1: Trong màn hình báo cáo tải trọng an toàn đầu kéo🡪 Nhấn nút ![](<../../.gitbook/assets/image (39).png>)
