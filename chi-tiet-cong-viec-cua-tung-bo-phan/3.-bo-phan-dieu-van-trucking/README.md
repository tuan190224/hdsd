...
* Ngoài ra, nếu chưa có lô hàng, người dùng vẫn có thể chọn Khách hàng và lên kế hoạch vận chuyển như bình thường. Lô hàng tự tạo sau đó được lưu sang Ql lô rút gọn. Nút tắt ![](<../../.gitbook/assets/1 (7).png>) được dùng để tải file danh sách cont lên phần mềm.
...
<figure><img src="../../.gitbook/assets/4 (6).png" alt=""><figcaption><p><em><strong>Màn hình Kế hoạch điều xe</strong></em></p></figcaption></figure>
...
* Trường hợp sử dụng xe ngoài chưa khai báo trong danh sách xe. Nhấn chọn thêm xe ![](<../../.gitbook/assets/7 (4).png>) tại bảng Thêm kế hoạch điều xe. Sau đó điền thông tin xe muốn điều.

(Chức năng này chỉ sử dụng cho xe thuê ngoài. Đối với xe của công ty, người dùng thêm mới xe tại **Danh sách xe** của mục TTC)

* Nhấn ![](<../../.gitbook/assets/8 (4).png>) nếu muốn điều thêm một xe khác với cùng thông tin lô.
...
* _Mỗi trạng thái sẽ hiển thị màu khác nhau:_ <img src="../../.gitbook/assets/image (27).png" alt="" data-size="original"><img src="../../.gitbook/assets/image (48).png" alt="" data-size="original">![](<../../.gitbook/assets/image (11).png>)![](<../../.gitbook/assets/image (38).png>)![](<../../.gitbook/assets/image (164).png>)
...
![Màn hình điều n xe – lô hàng đủ ](<../../.gitbook/assets/20 (2).png>)
...
![Màn hình thêm mới điều không lô](<../../.gitbook/assets/22 (1).png>)
...
![Màn hình Điều xe gộp cước](../../.gitbook/assets/23.png)
...
* Trường hợp người dùng muốn bổ sung thêm điểm giao hàng, nhấn nút ![](<../../.gitbook/assets/image (151).png>)
* Lợi nhuận %: được hiểu là lợi nhuận tính cho đội xe.
* Nhấn nút nếu muốn tiếp tục điều xe với các dữ liệu sẵn có <img src="../../.gitbook/assets/image (97).png" alt="" data-size="line">
...
<figure><img src="../../.gitbook/assets/image (103).png" alt=""><figcaption><p><em><strong>Màn hình bản đồ định vị các xe</strong></em></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (57).png" alt=""><figcaption><p><em><strong>Màn hình điều vận vận tải biển</strong></em></p></figcaption></figure>



* **Thao tác tạo mới chuyến điều vận:**

_**Bước 1**_: Nhấn nút <img src="../../.gitbook/assets/image (117).png" alt="" data-size="line"> → Nhập thông tin vào bảng thêm mới
...
<figure><img src="../../.gitbook/assets/image (34).png" alt=""><figcaption><p><em><strong>Màn hình thêm mới/cập nhật lại chuyến điều vận vận tải biển</strong></em></p></figcaption></figure>

* **Thao tác cập nhật lại cước biển:**

Trong trường hợp có phát sinh vấn đề cần cập nhật lại giá cước biển, người dùng sử dụng nút: <img src="../../.gitbook/assets/image (118).png" alt="" data-size="line"> . Thông tin cước sẽ được cập nhật lại theo dữ liệu hiện có trong Thông tin chung-Định mức cước biển.
...
<figure><img src="../../.gitbook/assets/image (81).png" alt=""><figcaption><p><em><strong>Màn hình quản lý cước vận chuyển</strong></em></p></figcaption></figure>
...
Bước 2: Trường hợp chưa có dữ liệu hoặc cần thay đổi, người dùng có thể chỉnh sửa trực tiếp tại các ô chữ màu xanh hoặc quay lại nhập từ TTC rồi chọn ![](<../../.gitbook/assets/image (61).png>)  để cập nhật lại cước.
...
<figure><img src="../../.gitbook/assets/image (107).png" alt=""><figcaption><p><em><strong>Màn hình Lưu ngược định mức cước</strong></em></p></figcaption></figure>
...
Cách 1: Làm mới chi phí một chuyến xe🡪 Nhấn nút ![](<../../.gitbook/assets/image (56).png>) để lấy lại giá trị định mức ban đầu.
...
<figure><img src="../../.gitbook/assets/image (88).png" alt=""><figcaption><p><em><strong>Màn hình quản lý chi phí vận chuyển</strong></em></p></figcaption></figure>
...
Bước 2: Trường hợp chưa có dữ liệu hoặc cần thay đổi, người dùng có thể chỉnh sửa trực tiếp tại các ô chữ màu xanh hoặc quay lại nhập từ TTC rồi chọn ![](<../../.gitbook/assets/image (67).png>) để cập nhật lại chi phí.
...
Bước 2: Kéo đến cột chức năng cuối bảng Ql chi phí vc🡪 Nhận nút <img src="../../.gitbook/assets/image (45).png" alt="" data-size="line">

Bước 3: Lựa chọn thông tin định mức muốn lưu trữ 🡪 Lưu

<figure><img src="../../.gitbook/assets/image (23).png" alt=""><figcaption><p><em><strong>Màn hình lưu ngược định mức tiền đường</strong></em></p></figcaption></figure>
...
Cách 1: Làm mới chi phí một chuyến xe🡪 Nhấn nút ![](<../../.gitbook/assets/image (160).png>) để lấy lại giá trị định mức ban đầu.

Cách 2: Làm mới chi phí nhiều chuyến cùng lúc: Tích chọn các chuyến cần chỉnh sửa 🡪 Nhấn nút Cập nhật định mức 🡪 Tích chọn phần chi phí cần chỉnh 🡪 Nhấn Xác nhận

<figure><img src="../../.gitbook/assets/image (79).png" alt=""><figcaption><p><em><strong>Màn hình cập nhật chi phí vận chuyển</strong></em></p></figcaption></figure>

#### **3.7.4 Đóng chi phí** <a href="#_45jfvxd" id="_45jfvxd"></a>

Khi người dùng đã xử lý xong quản lý cước của 1 chuyến, có thể sử dụng nút ![](<../../.gitbook/assets/image (85).png>) để đóng lại thanh toán của chuyến của chuyến vận chuyển, đồng nghĩ với việc các đơn giá sẽ không thể thay đổi giá trị được. Nếu muốn sửa đổi quản lý đã đóng, người dùng nhấn lại vào nút ![](<../../.gitbook/assets/image (43).png>) để mở.
...
<figure><img src="../../.gitbook/assets/image (159).png" alt=""><figcaption><p><em><strong>Màn hình nhập thông báo</strong></em></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (40).png" alt=""><figcaption><p><em><strong>Màn hình báo cáo hoạt động theo xe</strong></em></p></figcaption></figure>

<table data-header-hidden data-full-width="false"><thead><tr><th width="255"></th><th></th></tr></thead><tbody><tr><td>Số chuyến hàng cont</td><td>Số lượng chuyến vận chuyển với loại hàng cont</td></tr><tr><td>Số chuyến hàng rời</td><td>Số lượng chuyến vận chuyển với loại hàng rời</td></tr><tr><td>Tổng số chuyến (A)</td><td>= Số chuyến hàng cont + Số chuyến hàng rời</td></tr><tr><td>Tổng số km di chuyển (B)</td><td>Tổng km di chuyển của xe, lấy theo Ql chi phí vc</td></tr><tr><td>Km di chuyển trung bình</td><td>= B/A</td></tr><tr><td>Khối lượng</td><td>Lượng lái xe giao trong vận chuyển. Theo Ql cước vc</td></tr></tbody></table>
...
<figure><img src="../../.gitbook/assets/image (63).png" alt=""><figcaption><p><em><strong>Màn hình báo cáo hoạt động khách hàng</strong></em></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (89).png" alt=""><figcaption><p><em><strong>Màn hình Báo cáo tải trọng an toàn đầu kéo</strong></em></p></figcaption></figure>

<table data-header-hidden><thead><tr><th width="247"></th><th></th></tr></thead><tbody><tr><td>Tên khách hàng-…Loại cont</td><td>Lấy theo thông tin trong mục Điều xe</td></tr><tr><td>SK đầu kéo</td><td>Sức kéo đầu kéo. Theo khai báo trong TTC – Danh sách xe – Cột Khối lượng kéo theo TK/CP TGGT</td></tr><tr><td>Trọng lượng SMRM</td><td>Trọng lượng mooc. Theo khai báo trong TTC- Danh sách Rơmooc – Cột Trọng lượng Rơ mooc</td></tr><tr><td>Trọng lượng vỏ cont</td><td><p>Theo mặc định từ hệ thống</p><p>Cont 20’ = 2290 kg</p><p>Cont 40’ = 3628 kg</p></td></tr><tr><td>Khối lượng chở cho phép</td><td><p><strong>Cách tính 1:</strong> Khối lượng hàng CC theo TK/CP TGGT của SMRM - Trọng lượng vỏ Cont (lấy theo thông số nhỏ hơn- CP TGGT – cho phép tham gia giao thông)</p><p><strong>Cách tính 2:</strong> Khối lượng kéo đầu * 110% - Khối lượng mooc - Trọng lượng vỏ cont + 150 (Khối lượng kéo đầu lấy theo thông số nhỏ hơn của Khối lượng kéo theo TK/CP TGGT của Đầu kéo)</p><ul><li>So sánh kết quả 2 cách tính, hiển thị khối lượng nhỏ hơn</li></ul></td></tr><tr><td>Khối lượng hàng</td><td>= Lượng lx nhận trong Ql cước vc</td></tr><tr><td>Chênh lệch</td><td>= Khối lượng hàng – Khối lượng chở cho phép</td></tr><tr><td>Chức năng</td><td>Chức năng chỉnh sửa chỉ có đối với loại hàng chở cont, có đủ thông tin: Số xe, số mooc, loại cont</td></tr></tbody></table>

* **Cách kiểm tra Khối lượng chở cho phép của 1 chuyến hàng:**

<figure><img src="../../.gitbook/assets/image (86).png" alt=""><figcaption></figcaption></figure>

Bước 1: Trong màn hình báo cáo tải trọng an toàn đầu kéo🡪 Nhấn nút <img src="../../.gitbook/assets/image (13).png" alt="" data-size="line">
