...
* Trường hợp sử dụng xe ngoài chưa khai báo trong danh sách xe. Nhấn chọn thêm xe ![](<../../.gitbook/assets/7 (7).png>) tại bảng Thêm kế hoạch điều xe. Sau đó điền thông tin xe muốn điều.
...
![](<../../.gitbook/assets/15 (8).png>) ![](<../../.gitbook/assets/16 (1).jpeg>)
