...
Bước 2: Tại cột chức năng của bảng Quản lý tạm ứng, nhấn nút ![](<../../.gitbook/assets/1 (7).png>)🡪 Nhập thông tin tạm ứng 🡪 Lưu.
...
![Màn hình quản lý lương](<../../.gitbook/assets/7 (7).png>)

![H2. Màn hình các khoản giảm trừ tiền hàng lái xe](../../.gitbook/assets/8.png)

![H3. Màn hình Bảng lương lái xe](../../.gitbook/assets/9.png)
...
* Nút ![](<../../.gitbook/assets/image (56).png>) 🡪 Xác nhận: nếu muốn chốt chi phí lương của từng cá nhân
* Nút ![](<../../.gitbook/assets/image (55).png>) 🡪 Xác nhận: để chốt lương cho toàn bộ lái xe
...
<figure><img src="../../.gitbook/assets/image (35).png" alt=""><figcaption><p><em><strong>Màn hình thanh toán chi phí với lái xe</strong></em></p></figcaption></figure>
...
Bước 2: Tích chọn tại cột Thanh toán, chứng từ (nếu có). Có thể nhập số hóa đơn và ghi chú trực tiếp tại đây 🡪 Nhấn nút ![](<../../.gitbook/assets/image (148).png>) . Thông tin sau khi nhấn Lưu được đưa sang quản lý trong bảng Quản lý tạm ứng.
