...
<figure><img src="../../.gitbook/assets/0 (8).png" alt=""><figcaption><p><em><strong>Màn hình Quản lý thu chi lái xe</strong></em></p></figcaption></figure>
...
![Màn hình quản lý lương](<../../.gitbook/assets/6 (3).png>)
...
![H2. Màn hình các khoản giảm trừ tiền hàng lái xe](<../../.gitbook/assets/8 (7).png>)
...
* Nút ![](<../../.gitbook/assets/image (133).png>) 🡪 Xác nhận: nếu muốn chốt chi phí lương của từng cá nhân
* Nút ![](<../../.gitbook/assets/image (132).png>) 🡪 Xác nhận: để chốt lương cho toàn bộ lái xe
...
<figure><img src="../../.gitbook/assets/image (112).png" alt=""><figcaption><p><em><strong>Màn hình thanh toán chi phí với lái xe</strong></em></p></figcaption></figure>
...
Bước 2: Tích chọn tại cột Thanh toán, chứng từ (nếu có). Có thể nhập số hóa đơn và ghi chú trực tiếp tại đây 🡪 Nhấn nút ![](<../../.gitbook/assets/image (71).png>) . Thông tin sau khi nhấn Lưu được đưa sang quản lý trong bảng Quản lý tạm ứng.
