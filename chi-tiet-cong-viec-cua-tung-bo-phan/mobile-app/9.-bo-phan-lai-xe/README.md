...
Bước 2: Tại mục Quản lý hệ thống\_Quản lý nhóm 🡪 Tìm nhóm Lái xe (Thực hiện Thêm mới nếu chưa có) 🡪 Nhấn nút ![](<../../../.gitbook/assets/1 (3).png>)
...
Bước 2: Tìm lô muốn đổi quyền, nhấn nút ![](<../../../.gitbook/assets/10 (5).png>) 🡪 Chuyển trạng thái Trả cước sang:
...
Bước 1: Nhấn nút Chi trả hộ🡪 Nhấn ![](<../../../.gitbook/assets/13 (2).png>) để thêm các loại phí thu chi phát sinh
...
Bước 1: Nhấn nút Ảnh chứng từ 🡪 Nhấn ![](<../../../.gitbook/assets/17 (7).png>) để thêm ảnh

Bước 2: Chọn ảnh từ thư viện hoặc chụp trực tiếp 🡪 Nhấn Tải lên để đưa ảnh vào lưu trữ

![Không có mô tả.](<../../../.gitbook/assets/18 (2).png>)![](<../../../.gitbook/assets/19 (4).png>)
